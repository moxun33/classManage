...
<a href="/classManage?s=/Home/Index/login"><button class="am-btn am-btn-default am-topbar-btn am-btn-sm">登录
        ...
        <div data-am-widget="list_news" class="am-g am-g-fixed"><br/>
            ...
            <section class="am-panel am-panel-secondary">
                <header class="am-panel-hd">
                    <h3 class="am-panel-title">投票结果</h3>
                </header>
    ...
    <div class="am-u-lg-6 am-u-md-8 am-u-sm-centered">
            ...
            <section class="am-panel am-panel-primary">
                <header class="am-panel-hd">
                    <h3 class="am-panel-title">2011级信息安全2班关于毕业旅游地点的投票</h3>
                </header>
                <div class="am-panel-bd">
                    <form method="post" class="am-form" action="/classManage/?s=/Home/Activity/voteCount">
